...
class _BloodGlucoseWidgetViewState extends State<BloodGlucoseWidgetView> {
  ...
  void initState() {
    ...
    for (int timeValue = 1; timeValue <= 100; timeValue++) {
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: dayModeWidget(
                            isItMorning: true,
                            isMorningHoursSelected: isMorningHoursSelected,
                          ),
                        ),
                      ),
                      const SizedBox(
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: isRequestInProgress == true
                          ? () {
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            isRequestInProgress == true ? 'Processing' : 'Save',
...
Widget dayModeWidget({
  ...
  required bool isMorningHoursSelected,
}) {
  return Container(
    height: 45.0,
    // width: 130.0,
