...
class PatientsSummaryWidget extends StatefulWidget {
  const PatientsSummaryWidget({Key? key}) : super(key: key);

  @override
  State<PatientsSummaryWidget> createState() => _PatientsSummaryWidgetState();
}

class _PatientsSummaryWidgetState extends State<PatientsSummaryWidget> {
